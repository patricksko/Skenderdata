...
if __name__ == '__main__':
    ...
    parser.add_argument('input', help='''Path to the HDF5 dataset. It is the root folder of the dataset,
                        containing one subfolder for each generated scene''')
    parser.add_argument('output', help='''Where to export the dataset to YoloV7 format''')
